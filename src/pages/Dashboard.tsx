...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <header className="border-b bg-card md:bg-card px-4 sm:px-6 py-4 max-md:mobile-gradient-restaurant max-md:border-0 max-md:sticky max-md:top-0 max-md:z-30">
