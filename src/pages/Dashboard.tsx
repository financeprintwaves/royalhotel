          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <Card className="col-span-full">
              ...
              <CardContent className="flex flex-wrap gap-4">
                ...
                {(roles.includes('admin') || roles.includes('manager')) && (<Button size="lg" variant="outline" className="gap-2" asChild><Link to="/settings/printer"><Printer className="h-5 w-5" />Printer Settings</Link></Button>)}
              </CardContent>
            </Card>
